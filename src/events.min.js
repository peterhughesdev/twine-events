...
try{version.extensions.loadMacro={major:0,minor:1,revision:0},macros.event={init:function(){},handler:function(b,d,a){d=a.shift();if("on"===d&&"function"===typeof a[1])Events.on(a[0],a[1]);else"trigger"===d?Events.trigger(a.shift(),a,b):Events.trigger(d,a,b)}}}catch(e$$13){throwError(place,"Events error: "+e$$13.message)};